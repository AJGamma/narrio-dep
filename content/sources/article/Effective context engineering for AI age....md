...
[www.anthropic.com](https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents)
...
![](https://image.cubox.pro/cardImg/4dotms2d9z2idi6smig5b3ky0eql40k5nji7gzyi76bd4bfw7a?imageMogr2/quality/90/format/gif/ignore-error/1) *In contrast to the discrete task of writing a prompt, context engineering is iterative and the curation phase happens each time we decide what to pass to the model.*
...
![](https://image.cubox.pro/cardImg/j5v699jznlvt5hkut2n36f7zgzl1bymnhelcxealwfwnqr7rx?imageMogr2/quality/90/format/gif/ignore-error/1) *At one end of the spectrum, we see brittle if-else hardcoded prompts, and at the other end we see prompts that are overly general or falsely assume shared context.*
...
[Read in Cubox](https://cubox.pro/web/card/7440917691864451483)
